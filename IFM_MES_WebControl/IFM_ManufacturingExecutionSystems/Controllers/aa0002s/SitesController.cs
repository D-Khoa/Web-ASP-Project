...
namespace IFM_ManufacturingExecutionSystems.Controllers.aa0002s
{
    ...
    public class SitesController : ControllerBase
    {
        ...
        public SitesController(MESContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.aa0002.Where(x => !string.IsNullOrEmpty(x.aa0002c41)).ToListAsync();
        }
        ...
        {
            if (aa0002Exists(aa0002.aa0002c41))
            {
                return BadRequest("This Site Code Is Exists!");
            }
        ...
        private bool aa0002Exists(string sitecode)
        {
            return _context.aa0002.Any(e => e.aa0002c41 == sitecode);
        }
    }
}
